...
export default function Modifier({ open, handleClose, data, token }) {
	const [nom, setNom] = React.useState(data[0] ? data[0].nom : "");
	const [categorie, setCategorie] = React.useState(data[0] ? data[0].categorie : "");
	const [description, setDescription] = React.useState(data[0] ? data[0].description : "");
